locals {
  # Reference: https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsdirectoryservice.html
  ...
  access_level = {
    ...
    "AddIpRoutes",
    "AddRegion",
    "AuthorizeApplication [permission only]",
    ...
    "CreateDirectory",
    "CreateIdentityPoolDirectory [permission only]",
    ...
    "UnauthorizeApplication [permission only]",
    "UnshareDirectory",
    ...
    "GetDirectoryLimits",
    "GetSnapshotLimits",
    "ListAuthorizedApplications [permission only]",
    "ListIpRoutes",
