locals {
  # Reference: https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsrobomaker.html
  ...
  access_level = {
    ...
    "UpdateRobotDeployment [permission only]",
    ...
    "ListSimulationJobs",
    "ListSupportedAvailabilityZones [permission only]",
    "ListTagsForResource",
    "ListWorldExportJobs",
